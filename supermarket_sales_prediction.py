...
train=pd.read_csv(r'C:\Users\naveen chauhan\Desktop\mldata\mlp\msuperart Sale Prediction\Train.csv')
...
test=pd.read_csv(r'C:\Users\naveen chauhan\Desktop\mldata\mlp\supermart Sale Prediction\Test.csv')
...
def modelfit(alg,dtrain,dtest,predictor,target,IDcol,filename):
    ...
    submission.to_csv("C:\\Users\\naveen chauhan\\Desktop\\mldata\\mlp\\supermart Sale Prediction\\"+filename,index=False)
